...
namespace SysPet.Models
{
    public class PersonasViewModel
    {
        ...
        [Required(ErrorMessage = "El campo es obligatorio.")]
        [RegularExpression(@"^[a-zA-Z\sáéíóúÁÉÍÓÚ.,-]+$", ErrorMessage = "El campo contiene caracteres no permitidos.")]
        [StringLength(50, MinimumLength = 5, ErrorMessage = "El campo debe tener entre 3 y 25 caracteres.")]
        public string Ciudad { get; set; }

        [Required(ErrorMessage = "El campo es obligatorio.")]
        [RegularExpression(@"^[a-zA-Z0-9\sáéíóúÁÉÍÓÚ.,-]+$", ErrorMessage = "El campo contiene caracteres no permitidos.")]
        [StringLength(100, MinimumLength = 5, ErrorMessage = "El campo debe tener entre 3 y 25 caracteres.")]
        [DisplayName("Dirección")]
        public string Direccion { get; set; }

        [DisplayName("Código Postal")]
        [RegularExpression(@"^\d{5}$", ErrorMessage = "El campo debe tener 10 dígitos numéricos.")]
        public int CodigoPostal { get; set; }
        [DisplayName("Teléfono")]
        [RegularExpression("^[0-9]{10}$", ErrorMessage = "El campo debe tener 10 dígitos y solo puede contener números.")]
